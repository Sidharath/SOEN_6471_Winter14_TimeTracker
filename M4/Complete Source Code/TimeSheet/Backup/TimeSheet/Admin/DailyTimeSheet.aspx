<%@ Page Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true"
    CodeFile="DailyTimeSheet.aspx.cs" Inherits="Admin_DailyTimeSheet" Title="Daily Time Sheet" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="90%" border="0" cellspacing="6" cellpadding="0">
        ...
        <tr>
            <td align="left" valign="top">
                ...
                <asp:Button ID="btnExportTimeSheet" runat="server" CssClass="btnexporttimesheet"
                    ...
                    ValidationGroup="Validate" OnClick="btnExportTimeSheet_Click" />
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:GridView ID="grvDailyTimeSheet" runat="server" AutoGenerateColumns="false" OnDataBound="grvDailyTimeSheet_DataBound"
                    OnRowDataBound="grvDailyTimeSheet_RowDataBound" Width="100%"
                    EmptyDataText="No matching results found for the search criteria."
                    >
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                               <asp:Image ID="imgEmp" AlternateText="IMG" ImageUrl=""; runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField HeaderText="IMG" DataField="UserIMGPath"/>
                    </Columns>
                </asp:GridView>
            </td>
        </tr>
