<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true"
    CodeFile="DailyStatus.aspx.cs" Inherits="Admin_DailyStatus" %>
        ...
        function UpdateTimeSheet(rowid, number) {
            ...
            if (number == 1) {
                ...
                if (loValue != '') {
                    ...
                    //var projectid = Admin_DailyStatus.UpdateTimeSheetDetail(rowid, number, loValue);
                    var projectid = Admin_DailyStatus.UpdateTimeSheetDetail(FinalRowNo, number, loValue);
            ...
            if (number == 2) {
                ...
                //Admin_DailyStatus.UpdateTimeSheetDetail(rowid, number, loValue);
                Admin_DailyStatus.UpdateTimeSheetDetail(FinalRowNo, number, loValue);
            ...
            if (number == 3) {
                ...
                //var total = Admin_DailyStatus.UpdateTimeSheetDetail(rowid, number, loValue);
                var total = Admin_DailyStatus.UpdateTimeSheetDetail(FinalRowNo, number, loValue);
                if (loValue == "") {
            ...
            <table width="95%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td align="right" valign="top">
                        ...
                        <div class="floatr">
                            <asp:TextBox ID="txtChargoOffDate" runat="server" Width="75"></asp:TextBox>
                            <input type="button" id="Button1" style="background-image: url(../images/Calendar.jpg);
                                height: 16px; width: 16px; cursor: pointer; padding: 0px; border: none; background-color: Transparent;" />
                            <ajaxToolkit:CalendarExtender ID="endCal" runat="server" TargetControlID="txtChargoOffDate"
                                Format="dd-MMM-yy" PopupButtonID="Button1" CssClass="MyCalendar">
                ...
                <tr>
                    <td align="right" valign="top">
                        <asp:Button ID="btnSave" runat="server" CssClass="btnsave" onmouseover="this.className='btnsavehover'"
                            onmouseout="this.className='btnsave'" OnClick="btnSave_Click" ValidationGroup="validate" />
                    </td>
                </tr>
                <tr>
                    <td>
