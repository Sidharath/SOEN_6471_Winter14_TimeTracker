...
public partial class Admin_ModuleList : System.Web.UI.Page
{
  ...
  {
    Response.Redirect(clsFunctions.GetSiteRoot() + "/admin/ModuleDetail.aspx");
  } 
  #endregion
  ...
  protected void gvPlanList_RowDeleting(object sender, GridViewDeleteEventArgs e)
  {
    ...
    {
      Utility.getMessageFormat(lblMessage, Message.MODULE_DELETE, true);
    }
