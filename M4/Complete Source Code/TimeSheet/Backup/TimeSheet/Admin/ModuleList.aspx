<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModuleList.aspx.cs" MasterPageFile="~/Admin/admin.master"
  Inherits="Admin_ModuleList" %>
                  ...
                  <asp:GridView ID="gvPlanList" runat="server" AutoGenerateColumns="False" DataKeyNames="nmModule"
                    ...
                    <Columns>
                      ...
                      <asp:TemplateField HeaderText="Edit">
                        <ItemTemplate>
                          <a href="ModuleDetail.aspx?id=<%#Eval("nmModule")%>">
