<%@ Page Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true"
  CodeFile="HoursList.aspx.cs" Inherits="Admin_HoursList" %>
            ...
            <asp:UpdatePanel runat="Server" ID="UpdatePanel1">
              <ContentTemplate>
                <div class="padding5px default" align="center">
                  <asp:GridView ID="gvPlanList" runat="server" AutoGenerateColumns="False" DataKeyNames="nmHourID"
                    ...
                    BorderStyle="Dotted">
                    <Columns>
                      <asp:BoundField DataField="nmHourValue" SortExpression="nmHourValue" HeaderText="Hour Option">
                        <ItemStyle HorizontalAlign="left" />
                      </asp:BoundField>
                      <asp:TemplateField HeaderText="Edit">
                        <ItemTemplate>
                          <a href="HoursDetail.aspx?id=<%#Eval("nmHourID")%>">
